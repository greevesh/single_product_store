...
<div class="col-md-8 order-md-1 mt-5">
    ...
    <form action="{{ route('checkout.store') }}" method="POST" class="needs-validation" id="payment-form" novalidate>
        ...
        <form action="/charge" method="post" id="payment-form">
            <div class="form-row">
              ...
              <div style="color: red;" id="card-element">
    ...
    @if(Cart::count() == 0)
        <script>
            ...
            document.getElementById('no-products').textContent = "The product isn't in your cart!";
            document.getElementById('no-products').className = 'w-50 alert alert-danger';
        </script>
    @endif
